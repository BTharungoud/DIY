  ...
  return (
    <div className='homepage' style={containerStyle}>
      <div style={{padding:"20px",display:"flex"}}>
        <nav style={{padding:"10px",cursor:"pointer",marginLeft:"80%",marginRight:"2%",textDecorationLine:"underline"}} onClick={()=>{navigate("/")}}>HomePage</nav>
        <nav style={{border:"2px solid #F8EBE3",borderRadius:"20px",padding:"10px",cursor:"pointer"}} onClick={()=>{navigate("/login")}}>Login</nav>
      </div>
    <div id='block1'>
      ...
      <div className='homepagecotainer'>
        ...
        <h6 >This web-application DIY is designed to work as a waiter. 
